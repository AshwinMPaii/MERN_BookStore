...
import BooksTable from "../components/HomePage/BooksTable";
    ...
    return (
        <div className="flex flex-col items-center p-4 bg-black text-white w-screen h-screen">
            <div className="flex items-center gap-x-4">
                <button className="bg-sky-600 hover:bg-sky-400 hover:text-black px-4 py-1 rounded-lg" onClick={() => setShowType('table')}>
                    Table
                </button>
                <button className="bg-sky-600 hover:bg-sky-400 hover:text-black px-4 py-1 rounded-lg" onClick={() => setShowType('card')}>
                    Card
                </button>
            </div>
